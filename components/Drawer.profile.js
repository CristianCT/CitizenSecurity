                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View style={{flexDirection:'row',marginTop: 15}}>
                            ...
                            <View style={{marginLeft:15, flexDirection:'column'}}>
                                ...
                                <Caption style={styles.caption}>Ejemplo@Correo.com.co</Caption>
                            </View>
                        </View>
                    ...
                    <Drawer.Section style={styles.drawerSection}>
                        ...
                        <DrawerItem 
                            ...
                            label="History"
                            onPress={() => {props.navigation.navigate('History Profile')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
                            ...
                            label="Settings"
                            onPress={() => {props.navigation.navigate('Config Profile')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
                            ...
                            label="Support"
                            onPress={() => {props.navigation.navigate('Support Profile')}}
                        />
                    </Drawer.Section>
                </View>
